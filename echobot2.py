...
def train(bot, update):
    ...
    update.message.reply_text(jsonobj["ArrayOfObjStationData"]["objStationData"])
    nextTrainToMal = jsonobj["ArrayOfObjStationData"]["objStationData"][1]["Duein"]
    update.message.reply_text("The next train to Malahide is due in " + nextTrainToMal + " minutes")
