...
def classify_message(bot,update):
    ...
    ("Are there any stands?", 'bike'),
    ("How many stands?", 'bike'),
    ("Stands", 'bike'),
    ("Stand", 'bike'),
    ('Stand Guild Street', 'bike'),
    ('Stand Available', 'bike'),
    ('Where can I park', 'bike'),
    ('Free stands', 'bike'),
    ("Wheres is my closest station", 'closest'),
    ("Which is the closest staion", 'closest'),
    ("Wheres is the nearest station", 'closest'),
    ("Nearest station", 'closest'),
    ("Closest station", 'closest'),
    ("Which station is nearest", 'closest'),
